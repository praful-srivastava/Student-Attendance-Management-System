...
function Student() {
  ...
  <NavLink to="/student/timetable"  style={{ textDecoration: 'none' }}> <h5 className="card-title p-4 text-white">Attendance</h5></NavLink>
  ...
  <div className="card-body">
  <NavLink to="/student/noticeboard"  style={{ textDecoration: 'none' }}><h5 className="card-title p-4 text-white">Attendance Report</h5> </NavLink>
