       ...
       <div className="col-4 p-5 shadow bg-white">
          ...
          <div className='mb-3'>
           ...
           <div className='mb-3'>
              ...
              <input type='text' className='col-4' onChange={handleMobNo} value={username} name="username"></input>
                &nbsp;
                <br></br>
           ...
           <div className='mb-3'>
             ...
             <textarea className='col-5 form-control'onChange={handleAddress} value={password} name="password"> </textarea>
           </div>

           
           <div className='mb-3'>
             <label for ="moduleName">Module Name</label><br></br>
             <textarea className='col-100  form-control'onChange={handleAddress} value={moduleName} name="moduleName"> </textarea>
           </div>
           <br></br>
           <div className='mb-3'>
