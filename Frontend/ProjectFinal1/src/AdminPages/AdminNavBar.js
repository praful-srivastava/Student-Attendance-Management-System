...
<div className='navbar bg-dark px-5' >
   ...
   <a href="#"  style={{ textDecoration: 'none' }}><span className='fs-3 text-white ' style={{fontFamily:'monospace'}} ></span></a>
   
   <NavLink to="/admin"  style={{ textDecoration: 'none' }}><span className='fs-5 text-white'></span></NavLink>
